...
Understanding the dataset structure, variables, data types, and basic statistics.

### 2. Data Cleaning

Handling missing values, duplicates, inconsistent data, and preparing the dataset for analysis.
...
Creating charts and visualizations to identify trends and make comparisons between stocks and market indicators.

## 📈 Key Insights

The final analysis will highlight the main patterns and findings discovered in the Tadawul dataset, including stock performance, market trends, and other relevant indicators.

> **Note:** The insights in this section will be updated after completing the analysis.
